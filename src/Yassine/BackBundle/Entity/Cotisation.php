...
class Cotisation
{
     ...
     * Set idClient
     *
     * @param \Yassine\BackBundle\Entity\Client $idClient
     *
     * @return Cotisation
     */
    public function setIdClient(\Yassine\BackBundle\Entity\Client $idClient = null)
    {
     ...
     * Get idClient
     *
     * @return \Yassine\BackBundle\Entity\Client
     */
