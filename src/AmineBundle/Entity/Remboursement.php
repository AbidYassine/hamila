...
/**
 * @ORM\Entity(repositoryClass="AmineBundle\Repository\RemboursementRepository")
 */
/**
 * Remboursement
 *
 * @ORM\Table(name="remboursement", indexes={@ORM\Index(name="FK_id_client", columns={"id_client"})})
 * @ORM\Entity(repositoryClass="RemboursementRepository")
 */
class Remboursement implements NotifiableInterface
{
    /**
     * @var integer
     *
    ...
    public function notificationsOnCreate(NotificationBuilder $builder)
    {
        ...
        $notification
            ->setTitle('new Remboursement')
            ->setDescription($this->getIdRemboursement())
            ->setRoute(0)
            ->setIcon($this->getIdAssureur());
